...
# Load file
# f = open("B:/Nguyễn Quang Minh - Lớp 133584 - Bài tập nhóm GTS/Tìm trị riêng và vector riêng/13. Xuống thang tìm giá trị riêng trội tiếp theo/trị riêng trội thực, đơn.txt", "r")
# f = open("B:/Nguyễn Quang Minh - Lớp 133584 - Bài tập nhóm GTS/Tìm trị riêng và vector riêng/13. Xuống thang tìm giá trị riêng trội tiếp theo/trị riêng trội thực, bội.txt", "r")
# f = open("B:/Nguyễn Quang Minh - Lớp 133584 - Bài tập nhóm GTS/Tìm trị riêng và vector riêng/13. Xuống thang tìm giá trị riêng trội tiếp theo/trị riêng trội đối nhau.txt", "r")
f = open("B:/Nguyễn Quang Minh - Lớp 133584 - Bài tập nhóm GTS/Tìm trị riêng và vector riêng/13. Xuống thang tìm giá trị riêng trội tiếp theo/trị riêng phức.txt", "r")
a = f.readline()
n =  int(a)
