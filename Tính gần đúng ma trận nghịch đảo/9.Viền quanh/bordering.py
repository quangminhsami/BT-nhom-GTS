...
A = np.loadtxt("B:/BT nhóm GTS/Tính gần đúng ma trận nghịch đảo/9.Viền quanh/bordering.txt", dtype = 'float', delimiter = ' ')
...
np.savetxt("B:/BT nhóm GTS/Tính gần đúng ma trận nghịch đảo/9.Viền quanh/test_output_bordering.txt", s.dot(b), fmt= '%-.8f', delimiter = ' ')
